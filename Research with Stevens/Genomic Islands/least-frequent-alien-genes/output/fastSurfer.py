...
if len(sys.argv) < 5:
	print 'usage: python genomeLeastFrequency.py  <frequency-threshold> <min_length> <max_length> <gap_threshold>'
	sys.exit()
...
print 'Reading data...'
data = open('../../data/LocalFams_For_Rida', 'r')
for row in data:
...
input = open('../genomeIds.verified', 'r')
count = 0
done_genomes = []
SEs = {} 
